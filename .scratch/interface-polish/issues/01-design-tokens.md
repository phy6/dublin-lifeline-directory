...
- [ ] Create `src/lib/styles/tokens.css` with:
...
- [ ] Import tokens in `src/app.html` or `src/routes/+layout.svelte` so they're globally available
- [ ] Verify all existing hard-coded values have a token equivalent
