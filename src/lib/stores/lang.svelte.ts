...
const STRINGS = {
	en: {
		...
		'results-day': '{count} services found open on {day}',
		'results-all': '{count} services found across {categories} categories',
		'map-list-fallback': 'Service list (no map needed)',
		...
		'planner-download': 'Download appointment (calendar file)',
		'planner-download-week': 'Download week (calendar file)',
	...
	ga: {
		...
		'results-day': 'Aimsíodh {count} seirbhís ar oscailt {day}',
		'results-all': 'Aimsíodh {count} seirbhís i {categories} chatagóir',
		'map-list-fallback': 'Liosta seirbhísí (gan léarscáil)',
		...
		'planner-download': 'Íoslódáil coinne (comhad féilire)',
		'planner-download-week': 'Íoslódáil an tseachtain (comhad féilire)',
